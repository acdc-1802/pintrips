  ...
  render() {
    ...
    return (
      <div>
        ...
        {/* <Image className ="postcard-map" alt='static Mapbox map of users current location' src={`https://api.mapbox.com/styles/v1/mapbox/cj3kbeqzo00022smj7akz3o1e/static/${this.props.currentCoord[1]},${this.props.currentCoord[0]},12,0,0/700x700?access_token=pk.eyJ1IjoiY2lsYXZlcnkiLCJhIjoiY2pmMW1paDd0MTQ0bzJwb2Rtemdna2g0MCJ9.64yg764mTUOrL3p77lXGSQ`} rounded/> */}
      </div>
    )
  }
